                                        ...
                                        <div className="flex items-center justify-between p-4 border rounded-lg bg-gray-50">
                                            ...
                                            <label className="relative inline-flex items-center cursor-pointer">
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        console.log('Toggling Mock Discounts:', e.target.checked);
                                                        onUpdateMockSettings({ ...mockSettings, enableDiscounts: e.target.checked });
                                                    }}
                                                />
                                        ...
                                        <div className="flex items-center justify-between p-4 border rounded-lg bg-gray-50">
                                            ...
                                            <label className="relative inline-flex items-center cursor-pointer">
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        console.log('Toggling Mock Ratings:', e.target.checked);
                                                        onUpdateMockSettings({ ...mockSettings, enableRatings: e.target.checked });
                                                    }}
                                                />
                                                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-indigo-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-indigo-600"></div>
                                            </label>
