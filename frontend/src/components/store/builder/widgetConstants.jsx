...
import { Type, Square, Layout, List, MousePointer, Package, CreditCard, Image as ImageIcon, Grid, AlignLeft, Box, Search, Play, Phone, Mail, ShoppingBag, ShoppingCart, MessageSquare, Columns, Boxes } from 'lucide-react';
